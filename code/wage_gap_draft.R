...
### Q1 Does a general wage gap amongst countries exist ?
...
owid <- load_gender_wage_gap_data()
plot_wage_gap_distribution(owid)




### Q2 Regional and time based analysis
...
owid <- load_gender_wage_gap_data()
plot_wage_gap_gii_correlation(owid)
